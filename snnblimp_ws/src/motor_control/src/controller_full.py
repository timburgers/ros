...
class Controller:
    ...
    def init_SNN_model(self, pkl_file):
        ...
        pickle_in = open("/home/tim/ros/snnblimp_ws/src/motor_control/src/snn_controllers/"+pkl_file+".pkl","rb")
    ...
    def init_SNN_model_2(self, snn_contr_1, snn_contr_2):
        # Unpack the selected .pkl file 
        pickle_snn1 = open("/home/tim/ros/snnblimp_ws/src/motor_control/src/snn_controllers/"+snn_contr_1+".pkl","rb")
    ...
    ### Init the second snn controller
        ...
        # Unpack the selected .pkl file 
        pickle_snn2 = open("/home/tim/ros/snnblimp_ws/src/motor_control/src/snn_controllers/"+snn_contr_2+".pkl","rb")
    ...
    def init_SNN_model_3(self, snn_contr_1, snn_contr_2, snn_contr_3):
        ...
        # Unpack the selected .pkl file 
        pickle_snn3 = open("/home/tim/ros/snnblimp_ws/src/motor_control/src/snn_controllers/"+snn_contr_3+".pkl","rb")
